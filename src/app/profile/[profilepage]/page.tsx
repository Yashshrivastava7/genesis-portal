...
export default function ProfilePage() {
    ...
    if (loading) {
        return (
            <h1 className="m-3 text-center text-3xl">Loading...</h1>
        )
    }
                ...
                <div className="flex flex-col px-8 pb-8 pt-12 rounded-xl space-y-12 w-[500px] h-[500px] bg-[#97FEED] shadow-md">
                    ...
                    <form className="flex flex-col m-0" onSubmit={handleSubmit} >
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <select name="gender" id="gender" value={gender} defaultValue={"Select Your Option"} onChange={(e) => setGender(e.target.value)} placeholder="Select">
                        ...
                        <input type="tel" name="number" id="number" onChange={(e) => setNumber(e.target.value)} />

                        <h1 className="text-center mt-5">Social Media Links</h1>

                        <div className="flex flex-col ">
                            <input type="url" name="linkedin" id="linkedin" placeholder="LinkedIn Profile" onChange={(e) => setLinkedin(e.target.value)} />
                            <input type="url" name="github" id="github" placeholder="Github Profile" className="mt-5" onChange={(e) => setGithub(e.target.value)} />
                        </div>
